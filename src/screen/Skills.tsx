...
function Skills() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen gap-10">
      <div className="p-5 bg-accent rounded-lg flex flex-col justify-center items-center gap-10 shadow-lg">
        <h1 className="text-bgc text-2xl font-black">SKILLS</h1>
      </div>
      <div className="flex justify-center items-center gap-10">
        <div className="p-5 bg-content rounded-lg flex">
          <div>
            <h2 className="text-bgc text-lg font-bold text-center">
              Programming Language
            </h2>
            <div className="p-5 bg-content rounded-lg flex">
              <div className="grid grid-cols-3 gap-4">
                {languangeConfig.map((config) => (
                  <div key={config.id} className="flex flex-col items-center">
                    ...
                    />
                    <div className="text-bgc text-md font-medium text-center mt-2">
                      {config.name}
                    </div>
                  </div>
                ))}
